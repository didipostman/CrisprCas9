# Crispr Cas 9 
 Spring Batch + algorithm of DNA pattern recognition here I used Karp Rabin  = how Crispr Cas 9 function

A Java IT Model for DNA damage repair and Genome sequencing solution to fight Covid19 and other diseases = how Crispr Cas 9 function
Author: Wadï Mami
17/06/2020
email: didipostman77@gmail.com

 the Architecture sequence diagram describing how Spring Batch function and the dependency between Spring Batch Core and item reader, item Processor and item Writer + karp Rabin ( or any other pattern recognition algorithm) = How CRISPR Cas9 function see picture below and follow this link
...
A model for drugs discovery against Covid19 cancer diabète and many diseases
...
I will try to present my model for drugs discovery against Covid19 Cancer  diabete and many other diseases. In fact my IT model can be used to explain how Crispr Cas9 Works and then creating drugs based on that model may could be possible.
